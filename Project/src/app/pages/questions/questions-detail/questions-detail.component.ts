...
export class QuestionsDetailComponent implements OnInit {
  ...
  questions = [
    {
      ...
      detail:
        "I'm starting to learn Angular and wondering about the best practices to become proficient...",
      ...
      answers: [
        {
          answerId: 1,
          detail:
            'I recommend starting with the official documentation and building small projects.',
        ...
        },
        {
          answerId: 2,
          detail:
            'You can try various tutorials on YouTube to understand core concepts.',
    ...
    },
    {
      ...
      detail:
        "I've heard about lifecycle hooks in Angular, but I'm not sure how they work or when to use them...",
    ...
    },
    {
      ...
      detail:
        'Can someone explain the difference between reactive forms and template-driven forms in Angular?...',
    ...
    },
    {
      ...
      detail:
        'My Angular application seems to slow down as the project grows...',
    ...
    },
    {
      ...
      detail:
        "I'm having trouble fully understanding how dependency injection works in Angular...",
  ...
  onSubmit(): void {
    if (this.createAnswerForm.valid) {
      const { answertext, question_id, user_id } = this.createAnswerForm.value;
      console.log(answertext, question_id, user_id);
